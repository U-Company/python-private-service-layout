...
swagger_endpoint = f'{config.{{ cookiecutter.python_package }}_schema}://{config.{{ cookiecutter.python_package }}_host}:{config.{{ cookiecutter.python_package }}_port}/api-key?{config.{{ cookiecutter.python_package }}_api_key_name}={config.{{ cookiecutter.python_package }}_api_key}'
